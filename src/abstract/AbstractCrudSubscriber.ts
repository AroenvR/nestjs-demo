 ...
 */
@EventSubscriber()
export abstract class AbstractCrudSubscriber<Entity extends AbstractCrudEntity> extends AbstractLoggingClass implements EntitySubscriberInterface<Entity> {
    constructor(
