...
// 			expect(consumer.registerCallback).not.toHaveBeenCalled();
// 		});
...
// 			expect(consumer.registerCallback).toHaveBeenCalledWith(url, handler);
...
// 			service.post.mockReturnValue(loginBuilder);
// 			consumer.registerCallback.mockImplementation(() => {});
