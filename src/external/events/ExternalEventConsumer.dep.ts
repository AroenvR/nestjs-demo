...
//  */
// class MockExternalService extends ExternalCrudService {
// 	constructor(
...
// 		return new URL("http://api.example.com/v1/endpoint/events");
// 	}

// 	public async login(): Promise<string> {
// 		const token = await new Promise<string>((resolve) => resolve("bearer-token"));
...
// 	public async processServerSentEvent(data: unknown): Promise<void> {
...
// 	constructor(logAdapter: IPrefixedLogger, service: ExternalCrudService) {
...
// 			await consumer.loginAndStart();

// 			expect(loginSpy).toHaveBeenCalledTimes(1);
// 			expect(connectToEventSourceSpy).toHaveBeenCalledWith(service.getEventsUrl());
...
// 			const url = service.getEventsUrl();
...
// 			const handleEventSpy = jest.spyOn(service, "processServerSentEvent");
...
// 			await consumer.connectToEventSource(service.getEventsUrl());
...
// 			beforeEach(() => {
// 				handleEventSpy = jest.spyOn(service, "processServerSentEvent");
// 			});
